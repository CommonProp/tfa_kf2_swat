if CLIENT then
    killicon.Add( "tfa_kf2_mp7", "vgui/hud/tfa_kf2_mp7", Color( 225, 46, 46, 255 ) )
end 
...
SWEP.Description        = "Used by alphabet soup agencies and special forces units the world over."
SWEP.Type				= "Sub-machine Gun"
SWEP.Purpose			= "Choice of full-auto and semi-auto fire modes." --Purpose Tooltip
SWEP.PrintName			= "MP7 SMG"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 2				-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.Spawnable			= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable		= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.

SWEP.MuzzleFlashEffect          = "kf2_muzzle_suppressed"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_KF2.MP7.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Damage = (engine.ActiveGamemode() == "zombiesurvival" and 63) or 16 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = true -- Automatic/Semi Auto
SWEP.Primary.RPM = 952 -- This is in Rounds Per Minute / RPM

SWEP.Primary.LoopSound          = Sound("TFA_KF2.MP7.FireLoop") -- Looped fire sound, unsilenced
SWEP.Primary.LoopSoundTail      = Sound("TFA_KF2.MP7.FireLoopEnd") -- Loop end/tail sound, unsilenced
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_kf2/mp7/c_kf2_mp7.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 65		-- This controls how big the viewmodel looks.  Less is more.
SWEP.IronViewModelFOV	    = 63		-- This controls how big the viewmodel looks.  Less is more.
SWEP.VMPos = Vector(4.04, 7.28, -1.57) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
SWEP.VMAng = Vector(0, 0, 0) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
SWEP.CrouchPos = Vector(4.04, 7.28, -1.57) -- Defaults to nothing, use Vector(0, 0, 0) as starting point
SWEP.CrouchAng = Vector(0, 0, 0) -- Defaults to nothing, use Vector(0, 0, 0) as starting point

SWEP.ViewModelBoneMods = {
	["valvebiped.bip01_l_upperarm"] = { scale = Vector(1, 1, 1), pos = Vector(4.019, 5.527, -2.313), angle = Angle(-11.724, -29.901, 0) }
}

SWEP.VElements = {
	["mask"] = { type = "Model", model = "models/weapons/tfa_kf2/mp7/v_mp7_lense.mdl", bone = "RW_Sight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "kf2/nothing", skin = 0, bonemerge = true, active = true, bodygroup = {}, reticle = "models/weapons/tfa_kf2/mp7/v_mp7_lensering.mdl" }
}
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_kf2/mp7/w_kf2_mp7.mdl" --Wmodel path
SWEP.HoldType = "smg" -- This is how others view you carrying the weapon. Options include:
-- normal melee melee2 fist knife smg ar2 pistol rpg physgun grenade shotgun crossbow slam passive
-- You're mostly going to use ar2, smg, shotgun or pistol. rpg and crossbow make for good sniper rifles

--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(4.04, 7.28, -1.57)
SWEP.RunSightsAng = Vector(0, 0, 0)
SWEP.SafetyPos = Vector(4.04, 7.28, -1.57)
...
SWEP.MagModel = Model("models/weapons/tfa_kf2/mp7/mp7_mag.mdl")
SWEP.ShellModel = "models/weapons/tfa_kf2/shared/mp7_shell.mdl"
SWEP.ShellScale = 1.2
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0.5, type = "sound", value = Sound("TFA_KF2.MP7.MagOut")},
		{time = 1.1, type = "sound", value = Sound("TFA_KF2.MP7.MagIn")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0.3, type = "sound", value = Sound("TFA_KF2.MP7.MagOut")},
	...
	["Reload_Half_Elite"] = {
		{time = 0.3, type = "sound", value = Sound("TFA_KF2.MP7.MagOut")},
		{time = 0.6, type = "sound", value = Sound("TFA_KF2.MP7.MagIn")},
	},
	["Reload_Empty_Elite"] = {
		{time = 0.17, type = "sound", value = Sound("TFA_KF2.MP7.MagOut")},
		{time = 0.2, type = "lua", value = function(wep,vm) wep:KF2DropMag(0) end, client = true, server = true }, -- 0 for right hand, 1 for left hand
		{time = 0.64, type = "sound", value = Sound("TFA_KF2.MP7.MagIn")},
		{time = 1.05, type = "sound", value = Sound("TFA_KF2.MP7.SlideForward")},
	},
	["Guncheck_v1"] = {
		{time = 0.23, type = "sound", value = Sound("TFA_KF2.MP7.MagOut")},
		{time = 1.23, type = "sound", value = Sound("TFA_KF2.MP7.MagIn")},
	},
	["Guncheck_v2"] = {
		{time = 0.4, type = "sound", value = Sound("TFA_KF2.MP7.SlideBackInspect")},
		{time = 0.8, type = "sound", value = Sound("TFA_KF2.MP7.SlideForwardInspect")},
	},
	["Guncheck_v3"] = {
	...
	["Guncheck_v2_Empty"] = {
		{time = 0.5, type = "sound", value = Sound("TFA_KF2.MP7.SlideBackInspect")},
		{time = 0.8, type = "sound", value = Sound("TFA_KF2.MP7.SlideForwardInspect")},
	},
	["Guncheck_v3_Empty"] = {
		{time = 0.16, type = "sound", value = Sound("TFA_KF2.L85A2.Rustle")},
...
SWEP.SequenceLengthOverride = {
	[ACT_VM_DRAW] = 0.64,
	["Reload_Half"] = 2.14,
	["Reload_Half_Elite"] = 1.27,
	["Reload_Empty"] = 2.04,
	["Reload_Empty_Elite"] = 1.41,
}

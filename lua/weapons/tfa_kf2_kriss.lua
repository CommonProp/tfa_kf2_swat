if CLIENT then
    killicon.Add( "tfa_kf2_kriss", "vgui/hud/tfa_kf2_kriss", Color( 225, 46, 46, 255 ) )
end 
...
SWEP.Description        = "The latest in compact bullet redistrbution, it is a firehose of destruction."
SWEP.Type				= "Sub-machine Gun"
SWEP.Purpose			= "Choice of full-auto and semi-auto fire modes." --Purpose Tooltip
SWEP.PrintName			= "Kriss SMG"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_KF2.Kriss.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Damage = (engine.ActiveGamemode() == "zombiesurvival" and 60) or 33 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = true -- Automatic/Semi Auto
SWEP.Primary.RPM = 1200 -- This is in Rounds Per Minute / RPM

SWEP.Primary.LoopSound          = Sound("TFA_KF2.KRISS.FireLoop") -- Looped fire sound, unsilenced
SWEP.Primary.LoopSoundTail      = Sound("TFA_KF2.KRISS.FireLoopEnd") -- Loop end/tail sound, unsilenced
...
--Recoil Related
SWEP.Primary.KickUp = 0.36 -- This is the maximum upwards recoil (rise)
...
--Firing Cone Related
SWEP.Primary.Spread = .0210 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_kf2/kriss/c_kf2_kriss.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 72		-- This controls how big the viewmodel looks.  Less is more.
SWEP.IronViewModelFOV	    = 50		-- This controls how big the viewmodel looks.  Less is more.
SWEP.VMPos = Vector(3.74, 7.87, -1.18) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
SWEP.VMAng = Vector(0, 0, 0) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
SWEP.CrouchPos = Vector(3.74, 7.87, -1.18) -- Defaults to nothing, use Vector(0, 0, 0) as starting point
SWEP.CrouchAng = Vector(0, 0, 0) -- Defaults to nothing, use Vector(0, 0, 0) as starting point

SWEP.VElements = {
	["mask"] = { type = "Model", model = "models/weapons/tfa_kf2/kriss/v_kriss_lense.mdl", bone = "RW_Sight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "kf2/nothing", skin = 0, bonemerge = true, active = true, bodygroup = {}, reticle = "models/weapons/tfa_kf2/kriss/v_kriss_lensering.mdl" }
}
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_kf2/kriss/w_kf2_kriss.mdl" --Wmodel path
SWEP.HoldType = "smg" -- This is how others view you carrying the weapon. Options include:
-- normal melee melee2 fist knife smg ar2 pistol rpg physgun grenade shotgun crossbow slam passive
-- You're mostly going to use ar2, smg, shotgun or pistol. rpg and crossbow make for good sniper rifles

--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(3.74, 7.87, -1.18)
SWEP.RunSightsAng = Vector(0, 0, 0)
SWEP.SafetyPos = Vector(3.74, 7.87, -1.18)
...
SWEP.IronSightsPos = Vector(0.01, 5.91, 0.04)
SWEP.IronSightsAng = Vector(0, 0, 0)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(6.811, 4.977, -1.481)
SWEP.InspectAng = Vector(15.036, 32.743, 4.546)

--Shell eject override
SWEP.MagModel = Model("models/weapons/tfa_kf2/kriss/kriss_mag.mdl")
SWEP.ShellModel = "models/weapons/tfa_kf2/shared/kriss_shell.mdl"
SWEP.ShellScale = 1.2
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0.4, type = "sound", value = Sound("TFA_KF2.Kriss.MagOutHalf")},
		{time = 1.6, type = "sound", value = Sound("TFA_KF2.Kriss.MagInHalf")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0.4, type = "sound", value = Sound("TFA_KF2.Kriss.MagOut")},
		{time = 0.65, type = "lua", value = function(wep,vm) wep:KF2DropMag(0) end, client = true, server = true }, -- 0 for right hand, 1 for left hand
		{time = 1.48, type = "sound", value = Sound("TFA_KF2.Kriss.MagInA")},
		{time = 1.64, type = "sound", value = Sound("TFA_KF2.Kriss.MagInB")},
		{time = 1.9, type = "sound", value = Sound("TFA_KF2.Kriss.Slide")},
	},
	["Bash"] = {
	...
	["Reload_Half_Elite"] = {
		{time = 0.34, type = "sound", value = Sound("TFA_KF2.Kriss.MagOutHalf")},
		{time = 1.25, type = "sound", value = Sound("TFA_KF2.Kriss.MagInHalf")},
	},
	["Reload_Empty_Elite"] = {
		{time = 0.3, type = "sound", value = Sound("TFA_KF2.Kriss.MagOut")},
		{time = 0.5, type = "lua", value = function(wep,vm) wep:KF2DropMag(0) end, client = true, server = true }, -- 0 for right hand, 1 for left hand
		{time = 1, type = "sound", value = Sound("TFA_KF2.Kriss.MagInA")},
		{time = 1.1, type = "sound", value = Sound("TFA_KF2.Kriss.MagInB")},
		{time = 1.5, type = "sound", value = Sound("TFA_KF2.Kriss.SlideForwardInspect")},
	},
	["Guncheck_v1"] = {
		{time = 0.5, type = "sound", value = Sound("TFA_KF2.Kriss.SlideBackInspect")},
		{time = 0.9, type = "sound", value = Sound("TFA_KF2.Kriss.SlideForwardInspect")},
	},
	["Guncheck_v2"] = {
		{time = 0.2, type = "sound", value = Sound("TFA_KF2.L85A2.Rustle")},
		{time = 0.92, type = "sound", value = Sound("TFA_KF2.L85A2.Rustle")},
	},
	["Guncheck_v3"] = {
		{time = 0.47, type = "sound", value = Sound("TFA_KF2.Kriss.ButtonInspect")},
		{time = 0.6, type = "sound", value = Sound("TFA_KF2.Kriss.MagOutInspect")},
		{time = 1.5, type = "sound", value = Sound("TFA_KF2.Kriss.MagInInspect")},
	},
	["Guncheck_v2_Empty"] = {
		{time = 0.2, type = "sound", value = Sound("TFA_KF2.L85A2.Rustle")},
		{time = 0.92, type = "sound", value = Sound("TFA_KF2.L85A2.Rustle")},
...
SWEP.StatusLengthOverride = {
	...
	["Reload_Empty"] = 2.1,
	["Reload_Empty_Elite"] = 1.55,
}

SWEP.SequenceLengthOverride = {
	[ACT_VM_DRAW] = 0.64,
	["Reload_Half"] = 2.24,
	["Reload_Half_Elite"] = 1.75,
	["Reload_Empty"] = 2.36,
	["Reload_Empty_Elite"] = 1.8,
}
